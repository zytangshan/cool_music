...
import com.davidzhao.music.service.MediaService;
import com.davidzhao.music.view.KeyBoardKeyView;
...
public class MusicSearchListActivity extends FragmentActivity implements IConstant,
    ...
    private void initView() {
        ...
        deleteKey.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
