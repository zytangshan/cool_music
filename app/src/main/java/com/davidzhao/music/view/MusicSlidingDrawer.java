...
import com.davidzhao.music.interfaces.IOnSlidingHandleViewClickListener;

/**
 * Created by SPREADTRUM\david.zhao on 17-3-7.
 */

public class MusicSlidingDrawer extends SlidingDrawer {
    ...
    public MusicSlidingDrawer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MusicSlidingDrawer(Context context, AttributeSet attrs, int defStyle){
