...
public interface IConstant {
    public static final String BROADCAST_NAME = "com.davidzhao.music.broadcast";
    public static final String SERVICE_NAME = "com.davidzhao.music.service.MediaService";
    public static final String BROADCAST_QUERY_COMPLETE_NAME = "com.davidzhao.music.querycomplete.broadcast";
    public static final String BROADCAST_CHANGEBG = "com.davidzhao.music.changebg";
    public static final String BROADCAST_SHAKE = "com.davidzhao.music.shake";

    //是否开启了振动模式
    public static final String SHAKE_ON_OFF = "SHAKE_ON_OFF";

    public static final String SP_NAME = "com.davidzhao.music_preference";
    public static final String SP_MUSIC_BG_PATH = "bg_path";
    public static final String SP_VIDEO_BG_PATH = "video_bg_path";
    public static final String SP_IMAGE_BG_PATH = "image_bg_path";
    ...
    public static final String SP_CURRENT_TYPE = "current_type";
