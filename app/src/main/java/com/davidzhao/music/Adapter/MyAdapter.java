...
import com.davidzhao.music.Utils.StringHelper;
...
import com.davidzhao.music.ui.MyMusicManager;
...
import static com.davidzhao.music.ui.MyMusicUI.getMyMusicManager;

/**
 * Created by SPREADTRUM\david.zhao on 17-3-6.
 */

public class MyAdapter extends BaseAdapter implements IConstant {
    ...
    public MyAdapter(Context context, ServiceManager sm, SlidingDrawerManager sdm) {
        ...
        mMusicDao = new MusicInfoDB(context);
        times = 1;
    }
